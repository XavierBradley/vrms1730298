...
import com.champsoft.vrms1730298.modules.agents.domain.exception.InvalidRoleException;
    ...
    private String toReadableMessage(org.springframework.http.converter.HttpMessageNotReadableException ex) {
        ...
        while (current != null) {
            if (current instanceof com.fasterxml.jackson.databind.exc.InvalidFormatException ife) {
                if (ife.getTargetType() == com.champsoft.vrms1730298.modules.agents.domain.model.Role.class) {
